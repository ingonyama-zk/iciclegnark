...
func TestNttBN254CompareToGnarkDIF(t *testing.T) {
	...
	assert.Equal(t, nttResult, scalars)
	icicle.NttBN254(&nttResult, false, icicle.DIF, 0)
	assert.NotEqual(t, nttResult, scalars)
...
func TestNttBN254CompareToGnarkDIT(t *testing.T) {
	...
	assert.Equal(t, nttResult, scalars)
	icicle.NttBN254(&nttResult, false, icicle.DIT, 0)
	assert.NotEqual(t, nttResult, scalars)
...
func TestINttBN254CompareToGnarkDIT(t *testing.T) {
	...
	assert.Equal(t, nttResult, scalars)
	icicle.NttBN254(&nttResult, true, icicle.DIT, 0)
	assert.NotEqual(t, nttResult, scalars)
...
func TestINttBN254CompareToGnarkDIF(t *testing.T) {
	...
	assert.Equal(t, nttResult, scalars)
	icicle.NttBN254(&nttResult, true, icicle.DIF, 0)
	assert.NotEqual(t, nttResult, scalars)
...
func TestNttBN254(t *testing.T) {
	...
	assert.Equal(t, nttResult, scalars)
	icicle.NttBN254(&nttResult, false, icicle.NONE, 0)
	assert.NotEqual(t, nttResult, scalars)
	...
	icicle.NttBN254(&inttResult, true, icicle.NONE, 0)
...
func TestNttBatchBN254(t *testing.T) {
	...
	for i := 0; i < batches; i++ {
		...
		icicle.NttBN254(&nttResultVecOfVec[i], false, icicle.NONE, 0)
	}
